...
from users.views import SignUpApi, ProfileApi, ConfirmPhoneNumber, RequestCodeForLogin, RequestCode
...
urlpatterns = [
    ...
    path('request-code/',RequestCode.as_view() , name='request_code'),
